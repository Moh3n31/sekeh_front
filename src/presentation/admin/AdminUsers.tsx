...
export default function AdminUsers() {
	...
	return (
		<div className="p-7 max-md:p-4 overflow-y-auto h-full w-full scrollbar-gray flex flex-col gap-5">
			<header className="flex items-center justify-between gap-3 max-md:flex-col max-md:items-stretch">
				<h1 className="font-semibold text-2xl text-primary-text">Users</h1>
				<input
					value={search}
					onChange={(e) => {
						setPage(1);
			...
			<div className="rounded-lg border-2 border-border overflow-hidden overflow-x-auto">
				<table className="w-full text-[14px]">
					<thead className="bg-surface text-primary-action">
						<tr>
							<th className="text-right p-3 font-semibold">Username</th>
							<th className="text-right p-3 font-semibold max-md:hidden">Email</th>
							<th className="text-right p-3 font-semibold max-md:hidden">Phone</th>
							<th className="text-right p-3 font-semibold">Role</th>
							<th className="text-right p-3 font-semibold max-md:hidden">Joined</th>

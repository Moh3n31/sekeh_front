	...
	return (
		<div className="p-7 max-md:p-4 overflow-y-auto h-full w-full scrollbar-gray flex flex-col gap-5">
			<header className="flex items-center justify-between gap-3 max-md:flex-col max-md:items-stretch">
				<h1 className="font-semibold text-2xl text-primary-text">Jobs</h1>
				<input
					value={search}
					onChange={(e) => {
						setPage(1);
				...
				<table className="w-full text-[14px]">
					<thead className="bg-surface text-primary-action">
						<tr>
							...
							<th className="text-right p-3 font-semibold max-md:hidden">Company</th>
							<th className="text-right p-3 font-semibold max-md:hidden">Location</th>
							<th className="text-right p-3 font-semibold max-md:hidden">Source</th>
							<th className="text-right p-3 font-semibold">Embedding</th>
